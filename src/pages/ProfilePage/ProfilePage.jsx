        ...
        <div className="space-y-4">
          {recipients.map((recipient) => (
            <div
              ...
              className={`p-4 border rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md ${selectedRecipient?.careRecipientId === recipient.careRecipientId
...
const ProfilePage = ({ profile, onClose, onNavigate, district, dateRange }) => {
  ...
  const [chatMode, setChatMode] = useState('modal');
  const [isBookingLoading, setIsBookingLoading] = useState(false); // New loading state
  ...
  const calculateTotalPrice = () => {
    const pricePerHour = parseInt(profile?.servicePrice || '0', 10);
    ...
    const basePrice = pricePerHour * hours * days;
    return careType === 'hospital' ? basePrice * 1.3 : basePrice;
  };
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      setIsBookingLoading(false); // Stop loading
    }
  };
      ...
      <div className="p-6 bg-gray-50 min-h-[700px]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 flex flex-col min-h-[450px]">
              <img
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 flex flex-col min-h-[450px]">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <p className="text-gray-600 mb-4">Giá ở bệnh viện hơn 30% so với tại nhà</p>
                <p className="text-gray-600 mb-4">
        ...
        <div className="space-y-6 bg-white p-6 rounded-lg shadow-sm">
            ...
            <>
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00A37D] hover:border-[#A7F3D0] transition-all duration-300 ${formErrors.placeName ? 'border-red-500' : ''
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00A37D] hover:border-[#A7F3D0] transition-all duration-300 ${formErrors.bookingAddress ? 'border-red-500' : ''
                    }`}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00A37D] hover:border-[#A7F3D0] transition-all duration-300 ${formErrors.floor ? 'border-red-500' : ''
                      }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00A37D] hover:border-[#A7F3D0] transition-all duration-300 ${formErrors.roomNumber ? 'border-red-500' : ''
                      }`}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              className={`w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00A37D] hover:border-[#A7F3D0] transition-all duration-300 ${formErrors.notes ? 'border-red-500' : ''
                }`}
              rows="4"
    ...
    return (
      <div className="p-6 bg-gray-50 flex flex-col min-h-[700px] transition-all duration-300">
        ...
        <div className="rounded-xl p-6">
          ...
          <button
            className={`w-full bg-gradient-to-r from-[#00A37D] to-[#00C495] text-white font-medium py-2 px-6 rounded-lg hover:from-[#008C66] hover:to-[#00A37D] transition-all duration-300 flex items-center justify-center ${isBookingLoading ? 'opacity-50 cursor-not-allowed' : ''
              }`}
          ...
          <div className="p-6 bg-gray-50 rounded-lg min-h-[700px] flex flex-col items-center justify-center transition-all duration-300">
            <div className="text-center">
              ...
              <div className="flex gap-4 justify-center">
                ...
                >
                  Nhấn để liên hệ với {profile?.nameOfCareTaker || 'Bảo mẫu'}
                </button>
              </div>
            </div>
          </div>
