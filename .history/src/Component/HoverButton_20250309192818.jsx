...
const HoverButton = ({ text, showArrow = true, size = "medium" }) => {
  ...
  const { fontSize, height,
             arrowSize, arrowFontSize } = sizes[size] || sizes.medium;

  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100vh" }}>
      <div onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{ boxSizing: "border-box", height, display: "flex", alignItems: "center", gap: hovered && showArrow ? "10px" : "2px", transition: "gap 0.4s ease-in-out" }} > boxSizing: "border-box", height, display: "flex", alignItems: "center", gap: hovered && showArrow ? "10px" : "2px", transition: "gap 0.4s ease-in-out" }}
    >
      <button
        style={{
          position: "relative",
