  ...
  return (
    <button
      ...
      style={{ 
        ...
        cursor: "pointer",
        position: "relative",
        overflow: "hidden" // Quan trọng để giữ phần background transition trong nút
      }}
    >
      {/* Background overlay cho toàn bộ nút */}
      <div 
        style={{ 
          position: "absolute", 
      ...
      <span 
        style={{ 
          position: "relative",
          zIndex: "2", // Đảm bảo text hiển thị trên nền
      ...
      {showArrow && (
        <span 
          style={{ 
            position: "relative",
            zIndex: "2", // Đảm bảo mũi tên hiển thị trên nền
