...
const HoverButton = ({ text, showArrow = true, size = "medium" }) => {
  ...
  const { padding: `0 ${padding.split(' ')[1]}`, fontSize, height,
  ...
  return (
    <div
      ...
      style={{ boxSizing: "border-box", height, display: "flex", alignItems: "center", gap: hovered && showArrow ? "10px" : "2px", transition: "gap 0.4s ease-in-out" }}
    >
      <button
        style={{
          position: "relative",
