...
const HoverButton = ({ text, showArrow = true, size = "medium" }) => {
  ...
  return (
    <div
      ...
      style={{ boxSizing: "border-box", height, display: "flex", alignItems: "center", justifyContent: "center",height:"100vh", gap: hovered && showArrow ? "10px" : "2px", transition: "gap 0.4s ease-in-out" }}
    >
      <button
        style={{
          position: "relative",
