...
const sizes = {
  ...
  medium: { padding: "12px 24px", fontSize: "18px", height: "48px", arrowSize: "44", arrowFontSize: "24px" },
...
const HoverButton = ({ text, showArrow = true, size = "medium" }) => {
  ...
  return (
    ...
    <div
      ...
      style={{ display: "flex", alignItems: "center", gap: hovered && showArrow ? "10px" : "2px", transition: "gap 0.4s ease-in-out",justifyContent: "center",
        alignItems: "center",
        height: "100vh", }}
