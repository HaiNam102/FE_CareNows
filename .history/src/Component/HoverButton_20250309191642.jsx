...
const sizes = {
  small: { padding: "8px 16px", fontSize: "12px", height: "36px", arrowSize: "31px", arrowFontSize: "20px" },
  medium: { padding: "12px 24px", fontSize: "16px", height: "44px", arrowSize: "43px", arrowFontSize: "24px" },
  large: { padding: "16px 32px", fontSize: "20px", height: "56px", arrowSize: "55px", arrowFontSize: "28px" }
};
