...
const HoverButton = ({ text, showArrow = true, size = "medium" }) => {
  ...
  return (
    ...
    >
      <button
        style={{
          position: "relative",import React, { useState } from "react";

          const sizes = {
            small: { padding: "8px 16px", fontSize: "14px", height: "36px", arrowFontSize: "20px" },
            medium: { padding: "12px 24px", fontSize: "18px", height: "48px", arrowFontSize: "24px" },
