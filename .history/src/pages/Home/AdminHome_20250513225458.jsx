      ...
      <div style={{ flex: 1, padding: 32 }}>
        ...
        <div style={{ display: 'flex', gap: 32, marginTop: 32 }}>
          ...
          <div style={{ background: '#fff', borderRadius: 24, boxShadow: '0 2px 8px #0001', padding: 24, flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            ...
            <div style={{ alignSelf: 'center', position: 'relative', width: 190, height: 190, margin: '20px 0' }}>
              <div 
                style={{ 
                  width: '100%', 
                  height: '100%', 
              ...
              >
                <div style={{ fontSize: 16, color: '#757575', marginBottom: 5, padding: '0 20px', textAlign: 'center' }}>Chuyên viên chăm sóc</div>
