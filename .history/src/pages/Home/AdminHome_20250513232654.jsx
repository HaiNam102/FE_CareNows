    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f7f9fa', fontFamily: 'SVN-Gilroy' }}>
      ...
      <div style={{ flex: 1, padding: 32 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          ...
          {/* Lợi nhuận (biểu đồ) */}
          <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 8px #0001', padding: 32, minWidth: 340, maxWidth: 531, border: '0.75px solid #A6A6A6' }}>
          ...
          <div style={{ display: 'flex', gap: 32 }}>
            ...
            {/* Quản lý chuyên viên */}
            <div style={{ background: '#fff', borderRadius: 24, boxShadow: '0 2px 8px #0001', padding: 24, flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', height: '462px', border: '0.75px solid #A6A6A6' }}>
