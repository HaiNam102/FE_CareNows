...
import { LayoutDashboard, Users, Settings2, LogOut, Search, HandCoins, Fullscreen, Pen, Ellipsis, Info } from 'lucide-react';
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f7f9fa', fontFamily: 'SVN-Gilroy' }}>
      ...
      <div style={{ flex: 1, padding: 32 }}>
        ...
        {/* Lợi nhuận (biểu đồ) */}
        <div style={{ background: '#fff', boxShadow: '0 2px 8px #0001', padding: 32, minWidth: 340, maxWidth: 531, marginTop: 24, border: '0.75px solid #A6A6A6' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: 8, fontSize: 16 }}>
            <span style={{ background: '#C6E76D', color: '#1A1A1A', fontWeight: 600, borderRadius: 8, padding: '2px 10px', fontSize: 16, marginRight: 8, border: '0.75px solid #A6A6A6' }}>+12%</span>
            <span style={{ color: '#888', fontWeight: 400, fontSize: 16 }}>Tháng cao nhất</span>
          </div>
          <ResponsiveContainer width="100%" height={120}>
            <BarChart data={dataBar} barCategoryGap={0}>
              <XAxis
                dataKey="name"
