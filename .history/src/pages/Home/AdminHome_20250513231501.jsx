        ...
        <div style={{ display: 'flex', gap: 32, marginTop: 32 }}>
          ...
          <div style={{ background: '#fff', borderRadius: 24, boxShadow: '0 2px 8px #0001', padding: 24, flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            ...
            <div style={{ width: '100%', height: 300, display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', alignSelf: 'center' }}>
              {/* SVG for Outer Donut Chart with rounded corners and gap */}
              <svg 
                style={{
                  position: 'absolute',
                  width: 300,
              ...
              >
                <defs>
                  ...
                  <linearGradient id="pinkGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#FF6E91" />
                    <stop offset="100%" stopColor="#FF3355" />
                  </linearGradient>
                </defs>
                
                {/* Green arc (67% of circle) */}
                <path
                  d="M 150,150 m 0,-126 a 126,126 0 0 1 114.9,72 a 25,25 0 0 1 -22.5,35 a 25,25 0 0 1 -22.5,-15 a 76,76 0 0 0 -69.9,-43 a 25,25 0 0 1 0,-50 z"
                  fill="url(#greenGradient)"
                />
                
                {/* Pink arc (33% of circle) */}
                <path
                  d="M 150,150 m 0,126 a 126,126 0 0 1 -114.9,-72 a 25,25 0 0 1 22.5,-35 a 25,25 0 0 1 22.5,15 a 76,76 0 0 0 69.9,43 a 25,25 0 0 1 0,50 z"
