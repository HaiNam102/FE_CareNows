      ...
      <div style={{ width: 260, background: '#1a2e22', color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 24 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: 40 }}>
            ...
            <span style={{ fontWeight: 700, fontSize: 28, color: '#4be38a' }}>Care<span style={{ color: '#ff4e4e' }}>Now</span></span>
          </div>
          <div style={{ marginBottom: 16, background: '#d6f5c9', color: '#1a2e22', borderRadius: 8, padding: '10px 16px', display: 'flex', alignItems: 'center', fontWeight: 600 }}>
            <span style={{ marginRight: 10 }}>■</span> Dashboard
          </div>
          <div style={{ marginBottom: 16, borderRadius: 8, padding: '10px 16px', display: 'flex', alignItems: 'center', fontWeight: 500, cursor: 'pointer' }}>
            <span style={{ marginRight: 10 }}>●</span> Quản lý tài khoản
          </div>
        </div>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16, cursor: 'pointer' }}>
            <span style={{ marginRight: 10 }}>⚙️</span> Cài đặt
          </div>
          <div style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
            <span style={{ marginRight: 10 }}>↩️</span> Đăng xuất
          </div>
        </div>
      </div>
      {/* Main Content */}
      <div style={{ flex: 1, padding: 32 }}>
        <div style={{ display: 'flex', gap: 32 }}>
          ...
          <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 8px #0001', padding: 32, minWidth: 340, flex: 1 }}>
            <div style={{ fontSize: 32, fontWeight: 700 }}>$120,000,000 VNĐ</div>
            <div style={{ marginTop: 8, background: '#eafcd7', color: '#1a2e22', display: 'inline-block', borderRadius: 6, padding: '2px 10px', fontWeight: 600, fontSize: 14 }}>Tổng doanh thu</div>
            <div style={{ display: 'flex', gap: 32, marginTop: 24 }}>
              <div>
                <div style={{ color: '#888', fontWeight: 500 }}>Doanh thu báo mẫu</div>
                <div style={{ fontWeight: 700, fontSize: 20 }}>$88,000,000 VNĐ</div>
              </div>
              <div>
                <div style={{ color: '#888', fontWeight: 500 }}>Lợi nhuận</div>
                <div style={{ fontWeight: 700, fontSize: 20 }}>$36,000,000 VNĐ</div>
              </div>
            </div>
          </div>
          {/* Lợi nhuận (biểu đồ) */}
