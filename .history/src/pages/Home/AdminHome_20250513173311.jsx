      ...
      <div style={{ flex: 1, padding: 32 }}>
        <div style={{ display: 'flex', gap: 32 }}>
          ...
          <div style={{ 
            background: '#fff', 
            borderRadius: 16, 
            boxShadow: '-89px 138px 46px 0px rgba(105,105,105,0), -57px 88px 42px 0px rgba(105,105,105,0.01), -32px 50px 35px 0px rgba(105,105,105,0.05), -14px 22px 26px 0px rgba(105,105,105,0.09), -4px 6px 14px 0px rgba(105,105,105,0.10)',
            padding: 32, 
            minWidth: 340, 
            flex: 1 
          }}>
