    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f7f9fa', fontFamily: 'SVN-Gilroy' }}>
      ...
      <div style={{ flex: 1, padding: 32 }}>
        ...
        <div style={{ display: 'flex', gap: 32, marginTop: 32 }}>
          ...
          {/* Quản lý chuyên viên */}
          <div style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 8px #0001', padding: 24, flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            ...
            <ResponsiveContainer width="100%" height={231} minWidth={231} style={{ alignSelf: 'center' }}>
              <PieChart>
                <defs>
            ...
            <div style={{ position: 'relative', marginTop: -135, alignSelf: 'center', textAlign: 'center' }}>
              <div style={{ fontSize: 16, color: '#757575', marginBottom: 5 }}>Chuyên viên chăm sóc</div>
              <div style={{ fontWeight: 700, fontSize: 38, color: '#1a2e22' }}>120</div>
            </div>
