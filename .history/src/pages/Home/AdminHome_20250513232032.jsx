    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f7f9fa', fontFamily: 'SVN-Gilroy' }}>
      ...
      <div style={{ flex: 1, padding: 32 }}>
        ...
        <div style={{ display: 'flex', gap: 32, marginTop: 32 }}>
          ...
          {/* Quản lý chuyên viên */}
          <div style={{ background: '#fff', borderRadius: 24, boxShadow: '0 2px 8px #0001', padding: 24, flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', height: 'auto' }}>
