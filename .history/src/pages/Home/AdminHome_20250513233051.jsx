      ...
      <div style={{ flex: 1, padding: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 24 }}>
          ...
          <div style={{ flex: 3, display: 'flex', flexDirection: 'column', gap: 24 }}>
            {/* Top revenue stats */}
            <div style={{ display: 'flex', alignItems: 'center', gap: 24, background: '#fff', borderRadius: 16, padding: 24, border: '0.75px solid #E0E0E0' }}>
              {/* Total revenue */}
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 32, fontWeight: 600, color: '#1A1A1A', lineHeight: 1.2, marginBottom: 8 }}>
                  $120,000,000 VND
                </div>
                <div style={{ 
                  fontSize: 14, 
