      ...
      <div style={{ width: 260, background: '#1a2e22', color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 24 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: 40 }}>
            <img src={Logo} alt="logo" style={{ width: 212, height: 54, objectFit: 'contain', marginRight: 0 }} />
          </div>
          <div>
            {navs.map((nav, idx) => {
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16, cursor: 'pointer', padding: '16px 10px' }}>
