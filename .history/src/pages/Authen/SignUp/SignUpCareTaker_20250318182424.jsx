...
const SignUpCareTaker = () => {
  ...
  const handleNextStep = () => {
    if (currentStep === 1) {
      if (!formData.name || !formData.dob || !formData.gender || !formData.imgProfile || !formData.imgCccd) {
      ...
      if (!formData.username || !formData.password || !formData.email || !formData.phone) {
        toast.error('Vui lòng điền đầy đủ thông tin tài khoản và liên hệ!');
        return;
      }
    }
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB]">
      <div className="max-w-[1024px] mx-auto pt-[40px] px-6 pb-[40px]">
        ...
        {/* Step 2: Thông tin tài khoản và liên hệ */}
        {currentStep === 2 && (
          <>
            <div className="mb-8 bg-white rounded-lg p-8 shadow-sm w-[900px] mx-auto">
        ...
        {/* Step 3: Thông tin chuyên môn và cam kết */}
        {currentStep === 3 && (
          <>
            <div className="mb-8 bg-white rounded-lg p-8 shadow-sm w-[900px] mx-auto">
