...
const SearchResult = () => {
    ...
    const SearchFilters = () => {
        ...
        return (
            <div className="fixed top-[64px] left-0 right-0 z-40 bg-white shadow-md min-h-[150px]">
                ...
                <div className="flex items-center justify-center py-4 mb-2">
                    <div className="flex items-center space-x-4 text-sm text-gray-600">
                        ...
                        <div className="flex items-center">
                            ...
                            <span>{district || "Chọn địa điểm"}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center px-4 pb-4">
                    <div className="flex flex-wrap items-center justify-center gap-3 max-w-6xl w-full">
                        ...
                        <div className="flex items-center border border-[#00a37d] rounded-full px-4 py-2 min-w-[240px]">
                            <input 
                                type="text" 
                        ...
                        <button 
                            className="bg-[#00a37d] text-white rounded-full px-6 py-2.5 flex items-center whitespace-nowrap hover:bg-[#008f6c] transition-colors"
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            <SearchFilters />
            <div className="container mx-auto pt-[210px] pb-8 px-4">
