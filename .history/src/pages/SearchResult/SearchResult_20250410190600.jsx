...
const SearchResult = () => {
    ...
    const SearchFilters = () => {
        ...
        return (
            <div className="fixed top-[64px] left-0 right-0 z-40 bg-white shadow-md">
                <div className="flex flex-wrap items-center justify-center p-4 space-x-2 border-b">
                ...
                <div className="flex flex-wrap items-start justify-start p-4 space-x-2 overflow-x-auto">
                    <button className="border border-gray-300 rounded-full px-4 py-2 text-gray-700 whitespace-nowrap">Loại bảo mẫu</button>
                    <button className="border border-gray-300 rounded-full px-4 py-2 text-gray-700 flex items-center whitespace-nowrap">
                    ...
                    <button className="border border-gray-300 rounded-full px-4 py-2 text-gray-700 whitespace-nowrap">Chuyên viên 5*</button>
                    <button className="border border-gray-300 rounded-full px-4 py-2 text-gray-700 whitespace-nowrap">Năm kinh nghiệm</button>
                    <button className="border border-gray-300 rounded-full px-4 py-2 text-gray-700 whitespace-nowrap">Giờ dịch vụ</button>
                    <div className="flex items-center border border-[#00a37d] rounded-full px-2 py-2 min-w-[200px]">
                        <input type="text" placeholder="Tên bảo mẫu/Url" className="outline-none text-gray-700 w-full" />
                    </div>
                    <button 
                        className="bg-[#00a37d] text-white rounded-full px-4 py-2 flex items-center whitespace-nowrap"
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            <SearchFilters />
            <div className="container mx-auto py-4 mt-[160px]">
