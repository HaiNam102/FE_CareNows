...
const SearchResult = () => {
    ...
    const ProfileCard = ({ profile }) => {
        ...
        return (
            <div
                className="w-[261px] h-[377px] p-3 pb-[22px] bg-white rounded-lg border-[1px] border-[#8C8C8C] flex flex-col justify-center items-center gap-3 cursor-pointer hover:shadow-lg transition-shadow duration-300 font-['SVN-Gilroy']"
    ...
    return (
        <div className="min-h-screen font-['SVN-Gilroy'] overflow-x-hidden w-full">
            <div className="h-[150px] overflow-x-hidden w-full">
                <SearchFilters />
            </div>
            <div className="max-w-[1200px] mx-auto px-4 mt-8 overflow-x-hidden">
                <div className="min-h-[800px] overflow-x-hidden">
