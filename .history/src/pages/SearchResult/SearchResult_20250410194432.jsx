...
const SearchResult = () => {
    ...
    const ProfileCard = ({ profile }) => {
        ...
        return (
            <div
                className="group w-[261px] h-[377px] p-3 pb-[22px] bg-white rounded-lg border-[0.667px] border-[#8C8C8C] flex flex-col justify-center items-center gap-3 cursor-pointer transition-all duration-300 font-['SVN-Gilroy'] relative hover:border-transparent"
                onClick={() => handleProfileClick(profile)}
            >
                <div className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ background: 'linear-gradient(180deg, #34DC9934 0%, #99F8DC 100%)' }}></div>
