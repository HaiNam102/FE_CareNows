...
const SearchResult = () => {
    ...
    const SearchResult = () => {
        // ...các state và functions từ code gốc giữ nguyên
        ...
        return (
            <div className="bg-gray-100">
                <SearchFilters />
                {/* Thêm padding-top để tránh nội dung bị che bởi fixed filter */}
                <div className="container mx-auto py-4" style={{ paddingTop: '180px' }}> {/* Điều chỉnh giá trị này phù hợp với chiều cao của SearchFilters */}
                ...
                {/* Profile Page Overlay và Slide-in giữ nguyên */}
                {(isProfileOpen || selectedProfile) && (
                    <div className="fixed inset-0 z-50 overflow-hidden">
                        {/* Code phần overlay và profile slide-in giữ nguyên */}
                        <div
