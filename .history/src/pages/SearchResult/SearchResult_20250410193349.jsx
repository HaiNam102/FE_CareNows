...
const SearchResult = () => {
    ...
    const ProfileCard = ({ profile }) => {
        ...
        return (
            <div
                className="w-[261px] h-[377px] p-3 pb-[22px] bg-white rounded-lg border border-[#8C8C8C] flex flex-col justify-center items-center gap-3 cursor-pointer hover:shadow-lg transition-shadow duration-300 font-['SVN-Gilroy']"
