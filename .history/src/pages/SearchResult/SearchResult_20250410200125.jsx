...
const SearchResult = () => {
    ...
    const formatPrice = (price) => {
        ...
        if (numPrice >= 1000000) {
            return `${Math.floor(numPrice / 1000000)}tr`;
    ...
    const ProfileCard = ({ profile }) => {
        ...
        return (
            <div
                className="group w-[261px] h-[377px] p-3 pb-[22px] bg-white rounded-lg border-[0.667px] border-[#8C8C8C] flex flex-col justify-center items-center gap-3 cursor-pointer transition-all duration-300 font-['SVN-Gilroy'] relative hover:border-[#8C8C8C]"
                ...
                <div className="relative z-10 flex flex-col items-center gap-3 w-full">
                    ...
                    <div className="self-stretch flex justify-between items-center">
                        ...
                        <div className="flex items-baseline">
                            <span className="text-[#00a37d] text-[40px] font-semibold leading-[48px]">{formatPrice(profile.servicePrice)}</span>
                            <span className="text-[#121212] text-2xl font-semibold ml-0.5">/</span>
