        ...
        <div className="flex-1 bg-[#F9FAFB]">
          <main className="mx-auto w-full max-w-[900px] px-8 py-8">
            <div className="w-full">
              ...
              {/* Navigation Tabs */}
              <div className="bg-white rounded-lg mb-6 py-4 w-fit">
                <div className="w-[686px] h-[39px] px-[10px] py-[6px] flex items-center">
                  {categories.map((category, index) => (
                    <React.Fragment key={category.id}>
                      ...
                      >
                        {category.label === "Tất cả" ? "Tất cả" : 
                         category.label === "Đang thực hiện" ? "Đang thực hiện" :
                         category.label === "Đã hoàn thành" ? "Đã hoàn thành" : "Đã hủy"}
                      </button>
                      {index < categories.length - 1 && <div className="w-[161px] flex-shrink-0" />}
                    </React.Fragment>
                  ))}
                </div>
              </div>
