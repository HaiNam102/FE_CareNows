                    ...
                    <Card className="w-full hover:shadow-lg transition-shadow">
                      <CardHeader>
                        <div className="flex items-center justify-between">
                          ...
                          <Badge className={`${statusConfig.color} text-white px-4 py-1`}>
                            {statusConfig.text}
                          </Badge>
                        </div>
                      </CardHeader>
                        ...
                        <div className="flex items-start gap-6">
                          <div className="flex-1">
                            <div className="flex items-center gap-4 mb-4">
                              <div
                                className="w-16 h-16 bg-cover bg-center rounded-full border"
                              ...
                              <div>
                                ...
                                <div className="flex items-center gap-1 mt-1">
                                  ...
                                  <span className="text-lg font-medium">{booking.careTaker?.average_rating || 5}</span>
                                  <span className="text-muted-foreground">({booking.careTaker?.total_reviews || 20})</span>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="text-right">
                            ...
                            {booking.service_progress === 'COMPLETED' && (
                              <button className="text-[#00A37D] hover:underline mt-2 font-medium">
                                Đánh giá ngay
                              </button>
                            )}
                          </div>
