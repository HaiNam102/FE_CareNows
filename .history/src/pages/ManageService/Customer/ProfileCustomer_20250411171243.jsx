              ...
              <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button 
                    ...
                    className="px-4 py-2 text-[rgb(0,107,82)] border border-[rgb(0,107,82)] rounded-lg hover:bg-[rgb(0,107,82)]/5 transition flex items-center gap-2"
                  >
                    <PenSquare size={16} />
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-[500px]">
            ...
            <div className="flex justify-end gap-4 mt-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-[rgb(0,107,82)] text-white rounded-lg hover:bg-[rgb(0,87,62)] transition font-['SVN-Gilroy']"
              >
                Lưu thay đổi
              </button>
            </div>
