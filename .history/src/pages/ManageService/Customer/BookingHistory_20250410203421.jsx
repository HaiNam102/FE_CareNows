...
const BookingHistory = () => {
  ...
  const [bookings] = useState([
    {
      ...
      workDate: "Thứ hai, 22/11/2025",
      workTime: "08:00 đến 12:00",
      workDuration: "4 giờ",
      hospitalName: "Bệnh viện Đa khoa Đà Nẵng",
      hospitalAddress: "124 Hải Phòng, Thạch Thang, Hải Châu, Đà Nẵng",
      contactPerson: "Nguyễn Văn A",
      contactPhone: "(+84) 905123456",
      jobDescription: "Chăm sóc bệnh nhân sau phẫu thuật tim. Cần theo dõi các chỉ số sinh hiệu, hỗ trợ vận động nhẹ nhàng và chăm sóc vết thương.",
      hourlyRate: "125.000",
      totalHours: 4,
      transportFee: 50000,
      caregiver: {
    ...
    },
    {
      ...
      price: "750.000 VND",
      location: "Nhà riêng",
      workDate: "Thứ ba, 23/11/2025",
      workTime: "14:00 đến 20:00",
      workDuration: "6 giờ",
      hospitalName: "Chăm sóc tại nhà",
      hospitalAddress: "42 Trần Phú, Hải Châu, Đà Nẵng",
      contactPerson: "Trần Thị B",
      contactPhone: "(+84) 907234567",
      jobDescription: "Chăm sóc người cao tuổi (85 tuổi) bị liệt nửa người. Hỗ trợ vệ sinh cá nhân, tập vật lý trị liệu tại nhà, và theo dõi việc dùng thuốc.",
      hourlyRate: "125.000",
      totalHours: 6,
      transportFee: 0,
      caregiver: {
    ...
    },
    {
      ...
      workDate: "Thứ tư, 24/11/2025",
      workTime: "07:00 đến 10:00",
      workDuration: "3 giờ",
      hospitalName: "Bệnh viện Hoàn Mỹ Đà Nẵng",
      hospitalAddress: "161 Nguyễn Văn Linh, Thanh Khê, Đà Nẵng",
      contactPerson: "Lê Văn C",
      contactPhone: "(+84) 909345678",
      jobDescription: "Hỗ trợ chăm sóc trẻ 5 tuổi sau phẫu thuật ruột thừa. Theo dõi tình trạng vết thương và hỗ trợ các sinh hoạt cá nhân.",
      hourlyRate: "125.000",
      totalHours: 3,
      transportFee: 30000,
      caregiver: {
    ...
    },
    {
      ...
      statusColor: "bg-[#FF4842] text-white",
      price: "625.000 VND",
      location: "Bệnh viện Gia đình",
      workDate: "Thứ năm, 25/11/2025",
      workTime: "13:00 đến 18:00",
      workDuration: "5 giờ",
      hospitalName: "Bệnh viện Gia đình Đà Nẵng",
      hospitalAddress: "73 Nguyễn Hữu Thọ, Hải Châu, Đà Nẵng",
      contactPerson: "Phạm Thị D",
      contactPhone: "(+84) 903456789",
      jobDescription: "Chăm sóc bệnh nhân nữ (45 tuổi) sau tai biến. Hỗ trợ tập phục hồi chức năng, theo dõi các chỉ số và hỗ trợ sinh hoạt.",
      hourlyRate: "125.000",
      totalHours: 5,
      transportFee: 40000,
      caregiver: {
  ...
  const handleViewDetail = (booking) => {
    console.log("Navigating to booking detail:", booking); // Debug log
    const bookingData = {
      ...booking,
      workDate: "Thứ hai, 10/3/2025",
      workTime: "14:00 đến 18:00",
      workDuration: "4 giờ",
      hospitalName: "Bệnh viện Đa khoa Đà Nẵng",
      hospitalAddress: "Đa khoa Đà Nẵng, 124 Hải Phòng, Thạch Trang",
      contactPerson: "Nhật Tân",
