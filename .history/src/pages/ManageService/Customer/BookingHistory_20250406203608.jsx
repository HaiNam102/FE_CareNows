                        ...
                        <div className="bg-white rounded-[8px] p-6">
                          ...
                          <div className="space-y-4">
                            <div className="flex justify-between items-center">
                              <p className="text-[#212121] font-['SVN-Gilroy'] text-base font-bold">
                                Ngày book đơn: {booking.date}
                              </p>
                              <span className={`px-3 py-1 rounded-full text-sm font-['SVN-Gilroy'] ${booking.statusColor}`}>
                                {booking.statusLabel}
                              </span>
                            </div>

                            <p className="text-[#212121] font-['SVN-Gilroy'] text-[13px] font-medium">
                            ...
                            <div className="flex gap-4">
                              ...
                              <div className="flex-1">
                                <h3 className="text-[24px] font-medium font-['SVN-Gilroy']">{booking.caregiver.name}</h3>
                                  ...
                                  <div className="flex">
                                    {Array.from({ length: booking.caregiver.rating }).map((_, i) => (
                                      <Star
                                        key={i}
                                        size={16}
                                        className="fill-[#00A37D] text-[#00A37D]"
                                      />
                                    ))}
                                  </div>
                                  <span className="text-gray-400 text-sm">{booking.caregiver.ratingCount}</span>
                                </div>
                                <p className="text-[#8C8C8C] text-[13px] font-medium mt-1">{booking.serviceName}</p>
                                <button className="text-[#008667] text-[13px] font-medium mt-1 hover:underline">
                                  Đánh giá ngay
                                </button>
                              </div>

                              <div className="text-right">
                                <p className="text-[#008667] text-[24px] font-semibold font-['SVN-Gilroy']">
                                  {booking.price}
                                </p>
                                <div className="mt-4 h-[1px] bg-[#E8E8E8] mb-4"></div>
                                <button className="flex items-center text-[#006B52] text-[13px] hover:text-[#008667]">
