...
const ProfileCustomer = () => {
  ...
  const handleSave = async (field) => {
    try {
      ...
      // If updating address, split into ward and district
      if (field === 'address') {
      ...
      // If updating phone, use phoneNumber field
      if (field === 'phone') {
        updateData.phoneNumber = editValues.phone;
      }

      // If updating name, use nameOfCustomer field
      if (field === 'name') {
        updateData.nameOfCustomer = editValues.name;
      }
      ...
      if (response.data.code === 200) {
        ...
        // If updating address, update ward and district
        if (field === 'address') {
          const [ward, district] = editValues.address.split(', ');
          setUserData(prev => ({
            ...prev,
