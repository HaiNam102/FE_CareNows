            ...
            <div className="grid grid-cols-2 gap-6 mb-[400px]">
              {sortedBookings.map((booking) => {
                ...
                return (
                  ...
                  >
                    <Card className={`w-full bg-white rounded-lg transition-all duration-300 ${
                      ...
                      {activeCategory !== "all" && !isActive && (
                        <motion.div 
                          ...
                          className="absolute inset-0 z-10 bg-gray-100/30" 
                        />
                      )}

                      <CardHeader className={`px-6 py-1 transition-all duration-300 ${
                      ...
                      <CardContent className={`px-6 transition-all duration-300 ${
                        isActive ? "opacity-100" : "opacity-90"
                      }`}>
                      ...
                      <CardFooter className={`flex flex-col px-6 pb-2.5 transition-all duration-300 ${
                        isActive ? "opacity-100" : "opacity-90"
                      }`}>
