        ...
        <div className="flex-1">
          <main className="mx-auto w-full max-w-[900px] px-8 py-8">
            <div className="w-full">
              ...
              <div className="flex gap-[161px] mb-8 border-b border-gray-200">
                <button
                  onClick={() => setActiveTab('all')}
                  className={`px-4 py-2 font-['SVN-Gilroy'] relative ${
                    activeTab === 'all'
                      ? 'text-[#00A86B] after:absolute after:bottom-[-1px] after:left-0 after:w-full after:h-[2px] after:bg-[#00A86B]'
                      : 'text-gray-400'
                  }`}
                >
                  Tất cả
