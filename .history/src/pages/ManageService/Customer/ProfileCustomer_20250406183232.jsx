          ...
          <main className="mx-auto w-full max-w-[900px] px-8 py-8">
            <div className="w-full">
              ...
              <div className="mb-12">
                ...
                <div className="bg-white rounded-[8px] border border-gray-100 py-10 px-6">
                  <div className="flex">
                    ...
                    <div className="flex-1 pl-8">
                      <div className="grid grid-cols-2 gap-y-6 gap-x-8">
                        <div>
                          <p className="text-gray-400 text-lg font-['SVN-Gilroy']">Ngày sinh</p>
                          <div className="flex items-center justify-between mt-2">
                            {editMode.birthday ? (
                              <input
                                ...
                                className="text-xl border-b border-[rgb(0,107,82)] outline-none font-['SVN-Gilroy'] w-full"
                                onBlur={() => setEditMode(prev => ({ ...prev, birthday: false }))}
                                autoFocus
                              />
                            ) : (
                              <>
                                <p className="text-xl font-['SVN-Gilroy']">{userData.birthday}</p>
                                <button 
                        ...
                        <div>
                          <p className="text-gray-400 text-lg font-['SVN-Gilroy']">Giới tính</p>
                          <div className="flex items-center justify-between mt-2">
                            {editMode.gender ? (
                              <input
                                type="text"
                              ...
                              <>
                                <p className="text-xl font-['SVN-Gilroy']">{userData.gender}</p>
                                <button 
