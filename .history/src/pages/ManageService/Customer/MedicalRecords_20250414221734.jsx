  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data && response.data.code === 1011) {
        ...
        window.location.href = '/customer/medical-records';
      }
    } catch (err) {
                      ...
                      <div className="flex-1">
                        <div className="space-y-4">
                          {[
                            ...
                            { label: "Tuổi", value: recipient.year_old || "Tuổi chưa được cập nhật" },
