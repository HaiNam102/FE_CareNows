            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="flex justify-between mt-2">
                  <button className="border border-[#00A37D] text-[#00A37D] rounded-md py-2 px-4 hover:bg-[#00A37D]/5">
                    Liên hệ
                  </button>
                  <button className="bg-[#00A37D] text-white rounded-md py-2 px-8 hover:bg-[#00A37D]/90">
                    Thuê lại
                  </button>
                </div>
              </div>
    ...
    try {
      ...
      if (response.data?.code === 1010 && response.data?.data) {
        ...
        const bookingsWithDetails = bookingsData.map(booking => ({
          ...
          total_price: booking.price || 500000,
          careTaker: {
            ...
            average_rating: booking.rating || 5,
            total_review: 20,
