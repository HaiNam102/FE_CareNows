                      ...
                      >
                        <Card className="w-full bg-white rounded-lg">
                          ...
                          <CardHeader className="px-6 py-1">
                            ...
                            <div className="h-[0.75px] bg-[#006B52]/20 -mx-6 mt-4" />
                          </CardHeader>
                          ...
                          <CardFooter className="flex flex-col px-6 pb-2.5">
                            <div className="h-[0.75px] bg-[#006B52] -mx-6 mb-4" />
                            <div className="flex items-center justify-between w-full">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-[#006B52]">
                                <path d="M8.91003 19.92L15.43 13.4C16.2 12.63 16.2 11.37 15.43 10.6L8.91003 4.07999" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                              </svg>
                            </div>
                          </CardFooter>
                        </Card>
