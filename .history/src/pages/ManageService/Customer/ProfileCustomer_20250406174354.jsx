          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <div className="bg-white rounded-[8px] border border-gray-100 shadow-sm p-6">
                {/* User info container with specific dimensions */}
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6" style={{ width: '252px', height: '261px', overflow: 'hidden' }}>
                  {/* Profile Image */}
                ...
                {/* User Info Grid - Set to appear next to the 252x261 container */}
                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mt-4 sm:mt-0 ml-[252px] -mt-[261px]">
