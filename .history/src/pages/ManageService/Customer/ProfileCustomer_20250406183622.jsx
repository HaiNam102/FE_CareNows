                  ...
                  <div className="flex">
                    ...
                    <div className="flex-1 pl-8">
                      <div className="grid grid-cols-2 gap-y-6 gap-x-8">
                        <div className="bg-[#F9FAFB] rounded-[8px] p-6">
                          <p className="text-[#8C8C8C] text-base font-['SVN-Gilroy']">Ngày sinh</p>
                          <div className="flex items-center justify-between mt-1">
                            {editMode.birthday ? (
                              <input
                                ...
                                className="text-base border-b border-[rgb(0,107,82)] outline-none font-['SVN-Gilroy'] w-full"
                                onBlur={() => setEditMode(prev => ({ ...prev, birthday: false }))}
                                autoFocus
                              />
                            ) : (
                              <>
                                <p className="text-[#000000] text-base font-['SVN-Gilroy']">{userData.birthday}</p>
                                <button 
                        ...
                        <div className="bg-[#F9FAFB] rounded-[8px] p-6">
                          <p className="text-[#8C8C8C] text-base font-['SVN-Gilroy']">Giới tính</p>
                          <div className="flex items-center justify-between mt-1">
                            {editMode.gender ? (
                              <input
                                type="text"
                              ...
                              <>
                                <p className="text-[#000000] text-base font-['SVN-Gilroy']">{userData.gender}</p>
                                <button 
