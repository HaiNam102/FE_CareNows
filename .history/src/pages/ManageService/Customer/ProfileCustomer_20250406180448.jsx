...
const ProfileCustomer = () => {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col pl-[393px]"> {/* 141px (sidebar margin) + 252px (sidebar width) */}
        <Header />
        
        <main className="flex-1 py-8 mt-[123px] mx-auto w-full max-w-[900px] px-8">
          <div className="w-full">
            ...
            <div className="mb-12">
              ...
              <div className="bg-white rounded-[8px] border border-gray-100 shadow p-6">
                <div className="flex">
