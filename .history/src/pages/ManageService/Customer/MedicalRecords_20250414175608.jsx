...
const AddCareRecipientModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Chuyển đổi ngày từ dd/mm/yyyy sang yyyy-mm-dd trước khi gửi lên server
      ...
      const response = await axios.post(`${API_URL}/careRecipient/customer`, formattedData, {
        headers: {
      ...
      if (response.data && response.data.code === 1011) {
        ...
        // Tải lại trang sau khi đã cập nhật thành công
