...
const categories = [
  { id: "all", label: "Tất cả", color: "#00A3FF" },
  { id: "doing", label: "Đang thực hiện", color: "#F7B928" },
  { id: "completed", label: "Đã hoàn thành", color: "#11AA52" },
  { id: "cancelled", label: "Đã hủy", color: "#FF4842" },
];
        ...
        <div className="flex-1 bg-[#F9FAFB]">
          <main className="mx-auto w-full max-w-[900px] px-8 py-8">
            <div className="w-full">
              <div className="mb-8">
                <h2 className="text-[40px] leading-none font-semibold font-['SVN-Gilroy']">Xin chào Tan!</h2>
              </div>
              ...
              <div className="mb-6 flex items-center gap-2">
                {categories.map((category) => {
                  ...
                  return (
                    <button
                      key={category.id}
                      className={`h-[32px] px-4 rounded-full font-['SVN-Gilroy'] text-sm transition-all ${
                        isActive
