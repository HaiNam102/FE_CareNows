...
const mockBookings = [
  {
    ...
    jobDescription: "Chăm sóc người già, hỗ trợ vệ sinh cá nhân và ăn uống"
  },
  {
    id: "BK002",
    dateBooking: "2024-03-10",
    status: "ONGOING",
    careTaker: {
    ...
    jobDescription: "Chăm sóc bệnh nhân sau phẫu thuật, theo dõi sức khỏe"
  },
  {
    id: "BK003",
    dateBooking: "2024-03-05",
    status: "CANCELLED",
    careTaker: {
    ...
    contactName: "Hoàng Thị D",
    contactPhone: "0369852147",
    jobDescription: "Chăm sóc trẻ em, hỗ trợ học tập và vui chơi"
  }
];
            ...
            <div className="bg-gray-50 rounded-lg p-4 flex items-start gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <span className="text-[#00A86B] font-semibold">{booking.careTaker?.rating || 5}</span>
                  <span className="text-gray-500">({booking.careTaker?.reviewCount || 20})</span>
                </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex justify-between py-2">
                <span className="text-gray-600">Chi phí dịch vụ ({booking.duration} giờ x 120.000 VND)</span>
                <span className="text-gray-900">{booking.duration * 120000} VND</span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-gray-600">Phí di chuyển</span>
                <span className="text-gray-900">50.000 VND</span>
              </div>
                        ...
                        <div className="flex flex-col items-start gap-3 flex-1">
                          ...
                          <div className="flex items-center gap-2 self-stretch">
                            ...
                            <div className="[font-family:'SVN-Gilroy-Bold',Helvetica] font-bold text-[16px] leading-[19px]">
                              <span className="text-[#00a37d]">{booking.careTaker?.rating || 5}</span>
                              <span className="text-[#111111]">&nbsp;</span>
                              <span className="text-[#bcb9c5]">({booking.careTaker?.reviewCount || 20})</span>
                            </div>
                          </div>
