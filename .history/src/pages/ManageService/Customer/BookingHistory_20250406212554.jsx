            ...
            <div className="grid grid-cols-2 gap-6 mb-[400px]">
              {sortedBookings.map((booking) => {
                ...
                return (
                  ...
                  >
                    <Card className={`w-full bg-white rounded-lg transition-shadow duration-200 ${
                      isActive ? "shadow-lg hover:shadow-xl" : "shadow-sm"
                    }`}>
                      {activeCategory !== "all" && !isActive && (
                        <motion.div 
                          ...
                          className="absolute inset-0 z-10 bg-gray-200/60 backdrop-blur-[1px]" 
                        />
                      )}

                      <CardHeader className={`px-6 py-1 transition-opacity duration-200 ${
                      ...
                      <CardContent className={`px-6 transition-opacity duration-200 ${
                        isActive ? "opacity-100" : "opacity-70"
                      }`}>
                      ...
                      <CardFooter className={`flex flex-col px-6 pb-2.5 transition-opacity duration-200 ${
                        isActive ? "opacity-100" : "opacity-70"
                      }`}>
