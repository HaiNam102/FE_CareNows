            ...
            <div className="w-full">
              ...
              <div className="space-y-4">
                {careRecipients.map((recipient) => (
                  <div key={recipient.careRecipientId} className="bg-white rounded-[8px] border border-gray-100 p-6">
                      ...
                      <div className="flex-1">
                        <div className="space-y-4">
                          {[
                            ...
                            <div
                              key={index}
                              className="flex flex-col gap-1 px-3 py-4 rounded border border-[#c6c6c6]"
                            >
