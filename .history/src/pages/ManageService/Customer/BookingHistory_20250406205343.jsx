        ...
        <div className="flex-1 bg-[#F9FAFB]">
          <main className="mx-auto w-full max-w-[900px] px-8 py-8">
            <div className="w-full">
              ...
              {/* Navigation Tabs */}
              <div className="bg-white rounded-lg mb-6 inline-block">
                        ...
                        <Card className="w-full bg-white rounded-lg">
                          ...
                          <CardHeader className="px-5 py-1">
                            <div className="flex items-center justify-between">
                              ...
                              <Badge className={`${booking.statusColor} text-white [font-family:'SVN-Gilroy-Medium',Helvetica] font-medium text-[13px] leading-[26.3px]`}>
                                {booking.statusLabel}
                              </Badge>
                            </div>
                            ...
                            <div className="w-[100%] h-[0.75px] bg-[#006B52]/20" />
                          </CardHeader>
                          ...
                          <CardContent className="px-5">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex flex-col items-end gap-1 flex-1">
                                ...
                                <div className="font-heading-h5-h5-semibold text-[#00a37d] text-[24px] font-semibold whitespace-nowrap">
                                  {booking.price}
                                </div>
                              </div>
                            </div>
                          ...
                          <CardFooter className="flex flex-col px-5 pb-2.5">
                            <div className="w-full h-[0.75px] bg-[#006B52] mb-1.5" />
                            <div className="flex items-center justify-between w-full">
                              <div className="[font-family:'SVN-Gilroy-Medium',Helvetica] font-medium text-[#006B52] text-[13px] leading-[26.3px]">
                                Xem chi tiết
                              </div>
                              <ChevronRight className="w-[21px] h-[21px] text-[#006B52]" />
                            </div>
                          </CardFooter>
                        </Card>
                      </motion.div>
